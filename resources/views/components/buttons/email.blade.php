...
>
  ...
  <div class="left-1/2 absolute flex items-center gap-1.5 transition-transform -translate-x-1/2 translate-y-10 group-hover/button:translate-y-0 duration-350 ease-in-out">
