...
>
  <div class="flex font-bold uppercase tracking-wide transition-transform group-hover/button:-translate-y-10 duration-300 ease-in-out">
    {{ $slot }}
  </div>
  <div class="left-1/2 absolute flex items-center gap-1.5 transition-transform -translate-x-1/2 translate-y-10 group-hover/button:translate-y-0 duration-300 ease-in-out">
