<a
  ...
  class="group/button relative flex flex-col items-center bg-black px-7 py-3.5 rounded-full overflow-hidden text-white text-sm/5"
>
  <div class="flex font-bold uppercase tracking-wide transition-transform group-active/button:-translate-y-9 group-hover/button:-translate-y-10 duration-300 ease-in-out">
    {{ $slot }}
  </div>
  <div class="left-1/2 absolute flex items-center gap-1.5 transition-transform -translate-x-1/2 translate-y-10 group-active/button:translate-y-0 group-hover/button:translate-y-0 duration-300 ease-in-out">
