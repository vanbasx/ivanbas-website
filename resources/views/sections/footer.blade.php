<footer class="border-zinc-700 border-t">
  <div class="flex md:justify-between md:items-center gap-5 container">
    <div class="py-6 pr-8 max-md:border-zinc-700 max-md:border-r max-sm:text-sm">
      <span class="text-zinc-400">© 2025</span> All rights reserved
    </div>
    <ul class="flex max-md:flex-col items-center max-md:items-start gap-5 max-md:gap-3 max-md:col-span-2 py-6">
