<header class="top-0 left-0 z-10 fixed bg-zinc-950 border-zinc-700 border-b w-full">
  <div class="max-lg:flex max-lg:justify-between max-lg:items-center gap-5 grid grid-cols-6 container">
    <a href="mailto:hello@ivanbas.dev" class="z-10 flex items-center gap-1.5 col-span-2 py-5 w-fit font-medium max-sm:text-sm uppercase">
    ...
    <nav id="menu" class="max-lg:invisible max-lg:top-0 max-lg:left-0 max-lg:fixed col-span-4 max-lg:px-4 max-lg:w-full max-lg:h-full touch-none">
      <ul class="gap-5 max-lg:gap-2.5 grid lg:grid-cols-4 max-lg:py-32">
        ...
        <li class="lg:border-zinc-700 lg:border-l overflow-clip"><a href="/works" class="menu-item">Works</a></li>
